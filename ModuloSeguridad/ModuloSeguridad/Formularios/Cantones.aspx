<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cantones.aspx.cs" Inherits="ModuloSeguridad.Formularios.Cantones" %>
...
<body>
    ...
    <div>
        ...
        <asp:TextBox ID="txtPro" runat="server" Width="168px"></asp:TextBox>
        <br />
        <br />
...
&nbsp;&nbsp;
        ...
        <asp:TextBox ID="txtCa" runat="server" Width="170px"></asp:TextBox>
        <br />
        <br />
