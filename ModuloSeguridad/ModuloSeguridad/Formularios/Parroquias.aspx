<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Parroquias.aspx.cs" Inherits="ModuloSeguridad.Formularios.Parroquias" %>
...
<body>
    ...
    <div>
        ...
        <asp:TextBox ID="txtCa" runat="server" Width="168px"></asp:TextBox>
        <br />
        <br />
        <strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Codigo&nbsp;</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:TextBox ID="txtCod" runat="server" Width="169px"></asp:TextBox>
&nbsp;&nbsp;
        <br />
        <br />
        <strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Parroquia</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:TextBox ID="txtPa" runat="server" Width="170px"></asp:TextBox>
        <br />
        <br />
