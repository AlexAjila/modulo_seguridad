...
namespace ModuloSeguridad.Formulario
{
    ...
    {
        vProvincia datM = new vProvincia();

        #region FUNCIONES DE Provincia
        ...
        private void MostrarProvincia(string[] datos)
        {
            try
            {
                DataSet dsDatos = new DataSet();
                dsDatos = datM.MostrarProvincia(datos);
        ...
        protected void gvDatos1_SelectedIndexChanged1(object sender, EventArgs e)
        {
            try
            {
                ...
                txtCod.Text = gvDatos1.Rows[f].Cells[1].Text;
                txtNo.Text = gvDatos1.Rows[f].Cells[2].Text;
